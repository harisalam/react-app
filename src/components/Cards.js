      ...
      <div className='cards__container'>
        <div className='cards__wrapper'>
          <ul className='cards__items'>
            <CardItem
              src='images/research/puck.jpg'
              text='Hockey puck for Blind Ice Hockey'
              label='Research'
              path='/publications'
            />
            <CardItem
              src='images/research/animal.png'
              text='Non-visual Digital Graphics on Touchscreens'
              label='Research'
              path='/publications'
            />
             <CardItem
              src='images/research/forearm.png'
